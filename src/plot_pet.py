...
def plot_pca():
	log_pca_filepath = '../logs/pet_pca.csv'
	data_filepath = '../data/pet_pca.csv'
	base_graphpath = '../graphs/pet_pca.png'
	data_graphpath = '../graphs/pet_pca_2dim.png'
	...
	plt.title('Principle Component Analysis (Pet)')
	...
	# Plot
	plt.figure()
	plt.title("Pet dataset's First Two Principal Components")
...
def plot_ica():
	log_ica_filepath = '../logs/pet_ica.csv'
	base_graphpath = '../graphs/pet_ica.png'
	...
	color = 'tab:red'
	ax1.set_title('Independent Component Analysis (Pet)')
...
def plot_rca():
	log_rca_filepath = '../logs/pet_rca.csv'
	base_graphpath = '../graphs/pet_rca.png'
	...
	plt.figure()
	plt.title('Random Projections (Pet)')
	plt.xlabel('Number of components')
...
def plot_rf():
	log_rf_filepath1 = '../logs/pet_rf_impt.csv'
	log_rf_filepath2 = '../logs/pet_rf_acc.csv'
	base_graphpath = '../graphs/pet_rf.png'
...
def plot_reduced_kmeans():
	log_redkmeans_filepath = '../logs/pet_reduced_kmeans.csv'
	base_graphpath = '../graphs/pet_reduced_kmeans_@plot@.png'
...
def plot_reduced_gmm():
	log_redgmm_filepath = '../logs/pet_reduced_gmm.csv'
	base_graphpath = '../graphs/pet_reduced_gmm_@plot@.png'
