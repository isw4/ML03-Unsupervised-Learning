...
def rf(X, Y):
	...
	# Opening log file
	log_path = '../logs/wine_rf_impt.csv'
	with open(log_path, 'w') as f:
...
def kmeans_after_red(X, Y):
	...
	# Opening log file
	log_path = '../logs/wine_reduced_kmeans.csv'
	with open(log_path, 'w') as f:
...
def gmm_after_red(X, Y):
	...
	# Opening log file
	log_path = '../logs/wine_reduced_gmm.csv'
	with open(log_path, 'w') as f:
		f.write(
